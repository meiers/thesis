...
and others that led Darwin to the formulation of his theory of natural selection.
...
elements were identified in great detail \citep{Dunham2012}. The scientific
community then gained further insight into the variability within the human
population through population genetics studies \citep{Auton2015,Sudmant2015}.
...
Especially \emph{\acl{sv}}, which are introduced in \cref{sec:sv}, remained
...
last couple of years, new techniques for DNA sequencing (or based on standard
DNA sequencing) have become available. In this work, I utilize such emerging
technologies to characterize
\acl{sv} beyond what was previously possible.
...
limitations of structural variant detection in \cref{sec:limitations}. Then, in
...
traces in the genetic material that we call genetic \emph{variants} (or
\emph{mutations}). The typical nucleotide sequence of many species are known and
we express them in a so-called \emph{reference} genome (reference assembly).
Thus, variants are usually defined as a difference to such a reference. Some
variants only affect a single nucleotide, e.g. by changing a cytosine into a
thymine, and they are called \emph{\acfp{snv}}. Others,
termed \emph{\acfp{sv}} or sometimes just \emph{genomic rearrangements}, affect
larger portions of DNA and are the central topic of the research presented here.
...
tools that future research benefits from.
