...
\item \cite{Sexton2012} were the first ones discovering \acp{tad} in \textit{D.
    melanogaster}.
\item \cite{Rao2014} developed an \textit{in situ} \hic protocol and produced
...
\figuretextplusmargin{ggbio_dm6_2R_14Mb_2.jpg}{ggbio2}{Integrated visualization
    ...
    Notably, the gap in \hic contacts are now present in the balancer track.}
...
\figuretextplusmargin{ggbio_dm6_2R_14Mb_3.jpg}{ggbio3}{Integrated visualization
    ...
    genome that represents the genomic order of the balancer chromosomes.
    Notably, the gap in \hic contacts are now visible in the balancer track.}
