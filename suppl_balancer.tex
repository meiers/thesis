...
\begin{table}[ht]
    ...
    \begin{tabu}{llrrrl}
        \toprule
        Balancer & Chrom & $5\prime$ bp. & $3\prime$ bp.      & Del.(-)/ Dup.(+) &   Genes affected  \\
        \midrule
    ...
    \tabcap{blancer_breakpoints}{Breakpoint positions of balancer chromosomes}{
        ...
        chromosomes were identified in Hi-C data and refined through their
        paired-end signature uncovered by \delly. Values in italic could not be
        resolved at the base pair level.
    }
\end{table}
