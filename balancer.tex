...
\subsection{Studying \texorpdfstring{\textit{cis}}{cis}-regulation via
...
\subsection{Differences in chromatin conformation studied via haplotype-resolved Hi-C data}
