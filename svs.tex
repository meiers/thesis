...
However, this shall only be presented later in, \cref{sec:balancer_background},
together with our study on the functional consequences of \acp{sv}.
...
ploidy level (of all chromosomes). The expected \explain{ploidy}{Humans, who
    are diploid organisms, have $N=23$---meaning we carry 46 chromosomes in our cells.
...
originate. Because we understand certain the mechanisms of formation, we know
...
out how the complex \acp{sv} we find were formed.
...
simultaneously, \nehj can falsely ligate genomic loci in the wrong order and
...
losses, in concordance with a model of \acf{fostes} \citep{Zhang2009a,Carvalho2009}.
