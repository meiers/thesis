...
\usepackage{euler}       % \AMS Euler math font
...
% Calibri - the nicest one, but not free unfortunately.
% Linux Biolinum O - a bit particular.
% Open Sans - two dense (and line height seems smaller)
\setsansfont[Mapping=tex-text, Numbers=OldStyle]{Calibri}
