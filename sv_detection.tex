...
low frequency might remain undetected. As \cref{sec:mosaic_mosaicism} further
elaborates, this shortcoming has hampered studies on mosaic \acp{sv} in the past.
Recent technological advances allow the analysis of single cells. However, also
