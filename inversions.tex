...
whole-genome SNP genotyping on hundreds of individuals from multiple continents,
...
to discover rare SNVs  (minor allele frequency < 5\%) and to call copy number
...
non-rare SNPs in the studied populations. Besides novel insides on, for example,
...
nowadays commonly used file format \textsc{VCF}\footnote{Established for the
