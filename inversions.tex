...
The Human Genome Project, which, founded in 1990, was likely the first truly large-scale
...
came along with technical advances in methods and standardization such as the
...
or disease \citep{Campbell2017} and which eventually scale up the catalog of
...
\begin{table}[t]
    \begin{adjustbox}{inner,minipage=[b]{\textplusmargin}}
            ...
            \begin{minipage}[t]{0.54\textplusmargin}
                ...
                predicted inversions analyzed (\#Total), validated (\#Val.) and
...
sub-reads, yet with less sequencing errors, which is why I preferred the
...
\figuretextwidth{complex_invs.pdf}
    ...
    {Exemplary loci were selected to represent the most commonly seen
    ...
    consensus sequences and raw \ont MinION reads (vertical) are compared to their
...
more frequently. This is, however, not surprising as it is a known effect of \pcr
...
allele dropped out. This was not further explored so that \fdr estimates for the
...
outcome is a list of \explain{contigs}{\emph{Contiguous} stretches of DNA
...
\figuretwocolumns{inv_assemblies_qualities.pdf}
    ...
    to the reference genome, taking into account known variation of the sample.
...
yielding the best data per locus is explicitly listed in
...
parts of which had been analyzed beforehand \citep{Abyzov2015}. I filtered to
...
deletions as shown in \cref{fig:inv_assemblies_microhomology}. Interestingly,
...
mechanisms operating \citep{Hastings2009,Carvalho2016}, yet I deemed the signal
...
assemblies for different loci were available in \cref{sec:breakpoints}. In those
...
\acp{sv}, but the effective mechanisms still remain obscure. A higher number of
